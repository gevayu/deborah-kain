...
const values = [
  {
    ...
    title: "חוכמה פנימית",
    description:
      "אני מאמינה שיש בתוכנו מעיין שופע של יצירתיות וחוכמה, הנובע מעצם היותנו. לאורך הדרך אנחנו לפעמים מאבדים את הקשר אליו — ובעבודה משותפת אנחנו פותחים אותו מחדש, מקשיבים לו ולומדים לסמוך עליו.",
  },
  {
