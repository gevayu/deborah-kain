          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto items-center">
            ...
            >
              ...
              <p className="text-muted-foreground font-body leading-relaxed mb-4">
                במפגש האישי המקום הוא שלך, מותאם עבורך — קצב אישי, עומק מותאם, פרטיות מלאה. זה מרחב בטוח, קשוב ונטול שיפוט, שמכבד את החוכמה הפנימית שלך ומזמין אותה לדבר.
              </p>
              <p className="text-muted-foreground font-body leading-relaxed mb-4">
                כפסיכולוגית מומחית, העוסקת בפסיכותרפיה, אני מטפלת בקליניקה באופן פרטני, תוך שימוש אינטגרטיבי נרחב בכלים הבעתיים לפי הצורך — SoulCollage, פוטותרפיה, עבודה עם ארכיטיפים ודימויים.
              </p>
              <p className="text-muted-foreground font-body leading-relaxed mb-4">
                כמלווה רוחנית מוסמכת אני עוסקת בליווי אנשים הן בקליניקה והן בבית, בהתאם לצורך — כולל ליווי בצמתים מורכבים, רגעי שבר, וזמנים של פרידה.
              </p>
          ...
          <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
            {approaches.map((item, i) => (
              <motion.div
                ...
                className={`bg-primary/5 backdrop-blur-sm rounded-xl p-6 border border-primary/15 w-full md:w-[calc(50%-12px)] ${i === approaches.length - 1 ? 'lg:w-[calc(66.666%-8px)]' : 'lg:w-[calc(33.333%-16px)]'}`}
              >
