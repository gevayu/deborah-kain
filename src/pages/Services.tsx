...
const services = [
  {
    title: "סדנאות ומפגשים קבוצתיים",
    desc: "בואו לחוות סדרת סדנאות חווייתיות ומעצימות את הקול הפנימי. נעמיק יחד בתהליכים המשלבים עבודה עם דימויים, יצירה אינטואיטיבית ותשומת לב עמוקה לרגש. בסדנאות, כל משתתפת ומשתתף מקבלים מקום להיות, לחקור ולהעז — ללא שיפוט וללא צורך בכישרון אמנותי.",
    link: null,
    image: workshopCombined,
    webp: workshopCombinedWebp,
  },
  {
    title: "מפגשים אישיים — מרחב שלך לשהות משותפת",
    desc: "במפגש האישי המקום הוא שלך, מותאם עבורך — קצב אישי, עומק מותאם, פרטיות מלאה. כפסיכולוגית מומחית, העוסקת בפסיכותרפיה, אני מטפלת בקליניקה באופן פרטני, תוך שימוש אינטגרטיבי נרחב בכלים הבעתיים לפי הצורך. כמלווה רוחנית מוסמכת אני עוסקת בליווי אנשים הן בקליניקה והן בבית, בהתאם לצורך. מטפלת גם בשפה האנגלית.",
